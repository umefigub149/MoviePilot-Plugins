...
assert "演练模式" in source and "第一次启用时跳过以前的记录" in source
...
assert "v1.0.3" in plugin["history"] and "v1.0.2" in plugin["history"] and "v1.0.1" in plugin["history"] and "v1.0.0" in plugin["history"]
