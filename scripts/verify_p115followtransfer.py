...
assert "clouddrive_prefix" in source and "/115open" in source and "_candidate_storage_paths" in source
...
assert "_path_help_message" in source and "路径前缀填 /115open" in source
...
assert plugin["version"] == "1.0.6"
assert plugin["author"] == "umefigub149"
assert plugin.get("release") is False
assert "v1.0.6" in plugin["history"] and "v1.0.5" in plugin["history"] and "v1.0.4" in plugin["history"] and "v1.0.3" in plugin["history"] and "v1.0.2" in plugin["history"] and "v1.0.1" in plugin["history"] and "v1.0.0" in plugin["history"]
